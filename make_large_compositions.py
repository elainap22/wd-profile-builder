...
# determine the h-he boundary and he-core boundary for the model
...
make_composition_file(blend, model.header('net_name'), f'/#PATHNAME/compositions/M{org_initial_mass[0]}P{org_initial_mass[2:]}_CO_WD.data')


subprocess.run(['shmesa', 'change', 'inlist_wd_builder', 'initial_mass', f'{org_initial_mass}'])
subprocess.run(['shmesa', 'change', 'inlist_wd_builder', 'relax_composition_filename', f"'/#PATHNAME/compositions/M{org_initial_mass[0]}P{org_initial_mass[2:]}_CO_WD.data'"])
subprocess.run(['shmesa', 'change', 'inlist_wd_builder','save_model_filename', f"'/#PATHNAME/outputs/M{org_initial_mass[0]}P{org_initial_mass[2:]}_CO_WD.mod'"])